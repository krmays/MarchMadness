...
# Predicting the outcome of tournaments - Round 3
...
y_train <- Data_2002_19$rd_3[which(Data_2002_19[, 7] == 1 & Data_2002_19[, 2] <= as.character(as.numeric(year) - 1))]
x_train <- Data_2002_19[which(Data_2002_19[, 7] == 1 & Data_2002_19[, 2] <= as.character(as.numeric(year) - 1)),
                        c(4, seq(12, 38, by = 2))]
#These 2 lines are dependent on having Rd2_winners from Rd2.
y_test <- Data_2002_19$rd_3[which(Data_2002_19[, 2] == as.character(year) & Data_2002_19[, 1] %in% Rd2_winners$team)]
x_test <- Data_2002_19[which(Data_2002_19[, 2] == as.character(year) & Data_2002_19[, 1] %in% Rd2_winners$team), c(4, seq(12, 38, by = 2))]
